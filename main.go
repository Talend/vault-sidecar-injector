...
func main() {
	...
	flag.StringVar(&parameters.TemplateBlockFile, "tmplblockfile", config.ConfigFilesPath+"/templatetmplblock.hcl", "file containing the Template's template block")
	flag.StringVar(&parameters.TemplateDefaultFile, "tmpldefaultfile", config.ConfigFilesPath+"/templatetmpldefault.ctmpl", "file containing the Template's default template")
