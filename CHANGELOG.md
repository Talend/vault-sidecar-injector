...
From this release, the webhook certificate is no more generated using the Kubernetes Certificates API. This results in a simpler Helm chart (no need for post-install and pre-delete Helm hooks anymore) and remove some installation and cluster requirements. The certificate and associated private key are now either generated by code or read from an existing Kubernetes secrets. Refer to the updated [README.md](README.md) for details.

**Changed**

- [VSI #29](https://github.com/Talend/vault-sidecar-injector/pull/29) - Update HashiCorp Vault image to 1.4.2
- [VSI #30](https://github.com/Talend/vault-sidecar-injector/pull/30) - Webhook certificate generated by code or provided
