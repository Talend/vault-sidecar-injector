...
Finally, the webhook certificates are no more generated using the Kubernetes Certificates API. This results in a simpler Helm chart and remove some installation and cluster requirements. The certificates and associated private key are now either generated by code or read from a Kubernetes Secret you provide. Refer to the updated [README.md](README.md#webhook-certificates) for details.
...
- [VSI #32](https://github.com/Talend/vault-sidecar-injector/pull/32) - Inject secrets in env vars
